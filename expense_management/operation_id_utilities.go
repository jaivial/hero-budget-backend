...
// validateOperationIdOrGenerate validates provided operation ID or generates new one
// Used to handle both client-provided and server-generated operation IDs
